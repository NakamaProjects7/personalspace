...
<head>
    ...
    <style>
        ...
        .main { background-color: #064e3b; margin: 0 auto; width: 100%; max-width: 600px; border-radius: 16px; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5); border: 1px solid #065f46; }
        .header { background-image: linear-gradient(to bottom right, #022c22, #064e3b); padding: 50px 0; text-align: center; position: relative; overflow: hidden; }
        ...
        .title { color: #ffffff; font-size: 32px; font-weight: 800; margin: 0 40px; line-height: 1.2; letter-spacing: -0.5px; }
        .content { padding: 40px; }
        .article-card { background-color: #022c22; border-radius: 12px; overflow: hidden; border: 1px solid #065f46; text-align: center; }
        .article-image { width: 100%; height: auto; display: block; border-bottom: 1px solid #065f46; }
        .article-body { padding: 32px; }
        .article-title { color: #ffffff; font-size: 24px; font-weight: 700; margin-bottom: 16px; line-height: 1.3; }
        .article-excerpt { color: #d1fae5; font-size: 16px; line-height: 1.7; margin-bottom: 32px; }
        .btn { display: inline-block; background: linear-gradient(to right, #fbbf24, #d97706); color: #022c22; padding: 16px 40px; border-radius: 50px; font-weight: 800; text-decoration: none; font-size: 16px; box-shadow: 0 10px 15px -3px rgba(251, 191, 36, 0.3), 0 4px 6px -2px rgba(251, 191, 36, 0.1); transition: all 0.3s ease; text-transform: uppercase; letter-spacing: 0.5px; }
        ...
        .footer { text-align: center; color: #34d399; font-size: 13px; margin-top: 40px; padding: 0 20px; line-height: 1.6; }
        .unsubscribe { color: #6ee7b7; text-decoration: underline; transition: color 0.2s; }
        .unsubscribe:hover { color: #fbbf24; }
        .social-icons { margin-top: 24px; margin-bottom: 24px; }
        .social-link { display: inline-block; width: 32px; height: 32px; background-color: #065f46; border-radius: 50%; color: #d1fae5; line-height: 32px; margin: 0 8px; text-decoration: none; font-size: 14px; transition: all 0.2s; }
        .social-link:hover { background-color: #fbbf24; color: #022c22; transform: scale(1.1); }
        ...
        <div class="main">
            ...
            <div class="content">
                <div class="article-card">
                    @if($newsletter->image)
                        <img src="{{ Str::startsWith($newsletter->image, 'http') ? $newsletter->image : asset('storage/' . $newsletter->image) }}" alt="{{ $newsletter->title }}" class="article-image">
                    @endif
