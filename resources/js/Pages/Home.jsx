                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="order-2 lg:order-1">
                            ...
                            <div className="grid grid-cols-4 gap-4">
                                <a href="https://instagram.com/yourusername" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center p-4 rounded-xl bg-white/50 backdrop-blur-sm border border-secondary-200/50 shadow-sm hover:shadow-md hover:bg-white transition-all group">
                                ...
                                <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center p-4 rounded-xl bg-white/50 backdrop-blur-sm border border-secondary-200/50 shadow-sm hover:shadow-md hover:bg-white transition-all group">
                                ...
                                <a href="https://linkedin.com/in/yourprofile" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center p-4 rounded-xl bg-white/50 backdrop-blur-sm border border-secondary-200/50 shadow-sm hover:shadow-md hover:bg-white transition-all group">
